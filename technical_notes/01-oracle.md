...
(util/oracle.py:175 and util/oracle.py:177 called in turn; build_context is defined at util/evaluate.py:127-184)
...
(util/oracle.py:114-141 selecting edges and assigning severity; util/oracle.py:90-111 self-computing the two-way baseline flow)
...
(util/scenarios.py:24-52; util/oracle.py:178 the call; config.py:71-76 the support sets and η)
...
(util/oracle.py:144-168 taking the maximum completion slot; util/evaluate.py:95-108 list scheduling; util/evaluate.py:111-112 the completion slot; util/oracle.py:180-181 the call and the printed instance summary)
...
(util/oracle.py:231-244 the outer loop)
...
(util/oracle.py:270-271 the call; viz/oracle_viz.py:37-153 the three figures; viz/style.py:107 saving; there is also an entry point at util/oracle.py:284-298 that only re-renders the figures without recomputing)
