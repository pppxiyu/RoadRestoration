"""Objective-focused visualizations of the brute-force oracle (Nature publication style).

Writes, to outputs/oracle/figures/ (each as .png 600 dpi + editable .svg + .pdf):
  01_F_landscape       — F over all schedules best->worst (spread + optimum floor).
  02_F1_F2_tradeoff    — every schedule in (F2, F1) space; optimum + Pareto front.
  03_best_schedule     — optimal schedule: Gantt + demand drop/recovery + accessibility.
"""
